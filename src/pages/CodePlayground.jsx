...
${jsCode}`;
  ...
  return (
    <div className={`flex flex-col ${containerClass} ${isDarkMode ? 'bg-dark-bg' : 'bg-gray-100'}`}>
      {/* Header */}
      <div className={`flex items-center justify-end gap-2 p-2 border-b shrink-0 ${isDarkMode ? 'bg-dark-card border-dark-secondary' : 'bg-white border-gray-200'}`}>
