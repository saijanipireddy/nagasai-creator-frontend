...
const PracticeQuiz = ({ topic, onComplete, onBack, onReview }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 rounded-xl overflow-hidden">
      {/* Top bar */}
      <div className="shrink-0 flex items-center justify-between px-4 md:px-5 py-2.5 bg-white border-b border-slate-100">
      ...
      {/* Bottom navigation */}
      <div className="shrink-0 bg-white border-t border-slate-100 px-4 md:px-5 py-2.5">
